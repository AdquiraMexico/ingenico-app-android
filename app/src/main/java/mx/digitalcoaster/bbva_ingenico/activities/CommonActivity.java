...
public abstract class CommonActivity extends Activity implements CommonActivityInterface
{
    ...
    protected void initService() 
	{
		if (!mBound)
    	{
    	    ...
    	    mServiceConnection = new FlapRequests.PclServiceConnection();
	...
	{
		private mx.digitalcoaster.bbva_ingenico.activities.CommonActivity ViewOwner = null;
		...
		BarCodeReceiver(mx.digitalcoaster.bbva_ingenico.activities.CommonActivity receiver)
        {
            super();
            ViewOwner = receiver;
        }
	...
	private class StateReceiver extends BroadcastReceiver
	{
		...
		StateReceiver(mx.digitalcoaster.bbva_ingenico.activities.CommonActivity receiver)
        {
            super();
            ViewOwner = receiver;
        }
